// lucide dropped brand marks in v1, so the ones the site needs stay as inline
// paths here rather than being pasted into every component that wants them.
export const GithubIcon = ({ className = 'block size-4' }) => (
...
export const LinkedinIcon = ({ className = 'block size-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
